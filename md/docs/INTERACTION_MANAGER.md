...
- Wails 适配器示例（**历史已删除**）：原 `archive/prototype/wails-toolbar-app/interaction_manager.go`；迁移目标见 [`docs/wails-migration-boundary.md`](../../docs/wails-migration-boundary.md) → `apps/nmer-wails/`
