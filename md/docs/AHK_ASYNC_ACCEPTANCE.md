...
Run: `powershell -ExecutionPolicy Bypass -File tools\ci\LockAsyncAcceptance.ps1`
...
```powershell
powershell -ExecutionPolicy Bypass -File tools\ci\ValidateFourRefactors.ps1
powershell -ExecutionPolicy Bypass -File tools\ci\ValidateRequestIdStaleContract.ps1
powershell -ExecutionPolicy Bypass -File tools\ci\ValidateVoiceInputFsm.ps1
powershell -ExecutionPolicy Bypass -File tools\ci\CollectStaleDropLogs.ps1
```
