...
$stressScript = Nmer-ResolveCiScript $Root "CoreAsyncHttpStress.ahk"
$validator = Nmer-ResolveCiScript $Root "ValidateAsyncGuardrails.ps1"
$diagnoser = Nmer-ResolveCiScript $Root "DiagnoseAhkRuntime.ps1"
