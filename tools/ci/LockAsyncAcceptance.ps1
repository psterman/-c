...
$e2eStress = Nmer-ResolveCiScript $Root "RunAsyncGuardrailsE2E.ps1"
...
$valStress = Nmer-ResolveCiScript $Root "ValidateAsyncGuardrails.ps1"
...
if (-not $SkipRecovery) {
    ...
    try {
        ...
        $e2eRecovery = Nmer-ResolveCiScript $Root "RunRecoveryProbeE2E.ps1"
        ...
        $valRecovery = Nmer-ResolveCiScript $Root "ValidateRecoveryProbe.ps1"
...
$four = Nmer-ResolveCiScript $Root "ValidateFourRefactors.ps1"
if (Test-Path $four) {
